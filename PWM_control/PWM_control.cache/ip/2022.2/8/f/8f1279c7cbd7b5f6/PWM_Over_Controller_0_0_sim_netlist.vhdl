...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Controller is
  ...
  attribute FSM_ENCODED_STATES of \FSM_onehot_presentstate_reg[0]\ : label is "iSTATE:11,s2:100,s0:001,s1:010";
  attribute FSM_ENCODED_STATES of \FSM_onehot_presentstate_reg[1]\ : label is "iSTATE:11,s2:100,s0:001,s1:010";
  attribute FSM_ENCODED_STATES of \FSM_onehot_presentstate_reg[2]\ : label is "iSTATE:11,s2:100,s0:001,s1:010";
begin
  out0(2 downto 0) <= \^out0\(2 downto 0);
\FSM_onehot_presentstate[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (

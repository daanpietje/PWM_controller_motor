...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L secureip -L xpm --snapshot PWM_Over xil_defaultlib.PWM_Over -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  PWM_Over -key {Behavioral:sim_overview:Functional:PWM_Over} -tclbatch cmd.tcl -protoinst "protoinst_files/PWM_Over.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PWM_Over.wdb xsim.dir)

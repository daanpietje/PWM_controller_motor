...
HD_PWD='C:/Users/daanv/Desktop/Git/PWM_controller_motor/PWM_control/PWM_control.runs/PWM_Over_Comparator_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_Over_Comparator_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_Over_Comparator_0_2.tcl

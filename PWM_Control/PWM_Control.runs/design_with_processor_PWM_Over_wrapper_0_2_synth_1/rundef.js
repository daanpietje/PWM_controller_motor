...
ISEStep( "vivado",
         "-log design_with_processor_PWM_Over_wrapper_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_with_processor_PWM_Over_wrapper_0_2.tcl" );

...
HD_PWD='C:/Users/daanv/Desktop/Git/PWM_controller_motor/PWM_Control/PWM_Control.runs/Complete_design_car_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Complete_design_car_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Complete_design_car_axi_gpio_1_0.tcl

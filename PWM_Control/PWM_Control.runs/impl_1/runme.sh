...
HD_PWD='C:/Users/daanv/Desktop/Git/PWM_controller_motor/PWM_Control/PWM_Control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Complete_design_car_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Complete_design_car_wrapper.tcl -notrace

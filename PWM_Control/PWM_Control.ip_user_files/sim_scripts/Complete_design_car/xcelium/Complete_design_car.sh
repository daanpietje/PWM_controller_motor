...
#
# Script generated by Vivado on Thu Jun 29 13:30:36 +0200 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Complete_design_car.sh
...
#
# Usage        : Complete_design_car.sh
#                Complete_design_car.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Complete_design_car.sh [-reset_run]
#                Complete_design_car.sh [-reset_log]
#                Complete_design_car.sh [-help]
#
...
#                script (type 'Complete_design_car.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname processing_system7_vip_v1_0_16 -libname xil_defaultlib -libname axi_lite_ipif_v3_0_4 -libname lib_cdc_v1_0_2 -libname interrupt_control_v3_1_4 -libname axi_gpio_v2_0_30 -libname xlslice_v1_0_2 -libname generic_baseblocks_v2_1_0 -libname axi_register_slice_v2_1_28 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_crossbar_v2_1_29 -libname proc_sys_reset_v5_0_13 -libname xlconcat_v2_1_4 -libname axi_protocol_converter_v2_1_28 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_14 processing_system7_vip_v1_0_16 xil_defaultlib axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_4 axi_gpio_v2_0_30 xlslice_v1_0_2 generic_baseblocks_v2_1_0 axi_register_slice_v2_1_28 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29 proc_sys_reset_v5_0_13 xlconcat_v2_1_4 axi_protocol_converter_v2_1_28)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "Complete_design_car.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Complete_design_car.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../PWM_Control.gen/sources_1/bd/Complete_design_car/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../PWM_Control.gen/sources_1/bd/Complete_design_car/ipshared/aed8/hdl" +incdir+"../../../../PWM_Control.gen/sources_1/bd/Complete_design_car/ipshared/ec67/hdl" +incdir+"../../../../PWM_Control.gen/sources_1/bd/Complete_design_car/ipshared/aed8/hdl" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Complete_design_car xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Complete_design_car -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Complete_design_car_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Complete_design_car.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Complete_design_car.sh [-help]\n\
Usage: Complete_design_car.sh [-step]\n\
Usage: Complete_design_car.sh [-lib_map_path]\n\
Usage: Complete_design_car.sh [-reset_run]\n\
Usage: Complete_design_car.sh [-reset_log]\n\
Usage: Complete_design_car.sh [-keep_index]\n\
Usage: Complete_design_car.sh [-noclean_files]\n\n\

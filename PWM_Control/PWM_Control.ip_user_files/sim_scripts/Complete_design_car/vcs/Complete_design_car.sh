...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Complete_design_car xil_defaultlib.glbl -o Complete_design_car_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Complete_design_car_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Complete_design_car_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Complete_design_car_simv.daidir vcs_lib c.obj)

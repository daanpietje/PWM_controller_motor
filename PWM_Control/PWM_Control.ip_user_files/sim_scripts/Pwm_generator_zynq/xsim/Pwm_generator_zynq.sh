...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xlslice_v1_0_2 -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_14 -L processing_system7_vip_v1_0_16 -L generic_baseblocks_v2_1_0 -L axi_register_slice_v2_1_28 -L fifo_generator_v13_2_8 -L axi_data_fifo_v2_1_27 -L axi_crossbar_v2_1_29 -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_30 -L proc_sys_reset_v5_0_13 -L axi_protocol_converter_v2_1_28 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Pwm_generator_zynq xil_defaultlib.Pwm_generator_zynq xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Pwm_generator_zynq -key {Behavioral:sim_overview:Functional:Pwm_generator_zynq} -tclbatch cmd.tcl -protoinst "protoinst_files/PWM_Over.protoinst" -protoinst "protoinst_files/Pwm_generator_zynq.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Pwm_generator_zynq.wdb xsim.dir libdpi.so)

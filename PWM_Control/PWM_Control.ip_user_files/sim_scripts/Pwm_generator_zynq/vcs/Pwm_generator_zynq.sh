...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Pwm_generator_zynq xil_defaultlib.glbl -o Pwm_generator_zynq_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Pwm_generator_zynq_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Pwm_generator_zynq_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Pwm_generator_zynq_simv.daidir vcs_lib c.obj)
